...
PairStyle(tersoff/v01,PairTersoffV01)

#else

#ifndef LMP_PAIR_TERSOFF_V01_H
#define LMP_PAIR_TERSOFF_V01_H

#include "pair.h"

namespace LAMMPS_NS {

class PairTersoffV01 : public Pair {
 public:
  PairTersoffV01(class LAMMPS *);
  virtual ~PairTersoffV01();
...
E: Pair style Tersoff/v01 requires atom IDs
