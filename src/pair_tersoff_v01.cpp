...
PairTersoffV01::PairTersoffV01(LAMMPS *lmp) : Pair(lmp)
{
  single_enable = 0;
  restartinfo = 0;
  one_coeff = 1;
...
void PairTersoffV01::compute(int eflag, int vflag)
{
...
void PairTersoffV01::settings(int narg, char **/*arg*/)
{
...
void PairTersoffV01::coeff(int narg, char **arg)
{
  int i,j,n;
...
void PairTersoffV01::init_style()
{
...
double PairTersoffV01::init_one(int i, int j)
{
...
void PairTersoffV01::read_file(char *file)
{
...
void PairTersoffV01::setup_params()
{
  int i,j,k,m,n;
...
void PairTersoffV01::repulsive(Param *param, double rsq, double &fforce,
...
double PairTersoffV01::zeta(Param *param, double rsqij, double rsqik,
...
void PairTersoffV01::force_zeta(Param *param, double rsq, double zeta_ij,
...
void PairTersoffV01::attractive(Param *param, double prefactor,
...
double PairTersoffV01::ters_fc(double r, Param *param)
{
...
double PairTersoffV01::ters_fc_d(double r, Param *param)
{
  double ters_R = param->bigr;
  double ters_D = param->bigd;
...
double PairTersoffV01::ters_fa(double r, Param *param)
{
...
double PairTersoffV01::ters_fa_d(double r, Param *param)
{
  if (r > param->bigr + param->bigd) return 0.0;
...
double PairTersoffV01::ters_bij(double zeta, Param *param)
{
...
double PairTersoffV01::ters_bij_d(double zeta, Param *param)
{
  double tmp = param->beta * zeta;
...
void PairTersoffV01::ters_zetaterm_d(double prefactor,
...
void PairTersoffV01::costheta_d(double *rij_hat, double rij,
                             double *rik_hat, double rik,
                             double *dri, double *drj, double *drk)
{
